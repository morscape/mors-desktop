...
class SequenceDefinition extends DualNode {
	...
	getField7052(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"am", ['int', -1722605769]);
	}
	getField7053(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"an", ['int', 450018821]);
	}
	getField7054(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"ao", ['int', -2114329311]);
	}
	getField7055(){
	...
	getField7059(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"aw", ['int', -603738307]);
	}
	getField7060(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"ay", ['int', -229393753]);
	}
	getFrameCount(){
		return  super.getField(SequenceDefinition.obfuscatedClassName,"ab", ['int', -1362654329]);
	}
