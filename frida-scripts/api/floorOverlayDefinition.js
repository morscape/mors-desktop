...
class FloorOverlayDefinition extends DualNode {
	...
	static getField7104(){
		return  super.getField(FloorOverlayDefinition.obfuscatedClassName,"ed", ['int', -599000959]);
	}
	static getField7100(){
	...
	getSaturation(){
		return  super.getField(FloorOverlayDefinition.obfuscatedClassName,"aa", ['int', -974563495]);
	}
	getSecondaryHue(){
	...
	getLightness(){
		return  super.getField(FloorOverlayDefinition.obfuscatedClassName,"ab", ['int', -1292562765]);
	}
