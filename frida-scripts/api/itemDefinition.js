...
class ItemDefinition extends DualNode {
	...
	getXan2d(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"ac", ['int', -1038465255]);
	}
	getZoom2d(){
	...
	getModel(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"ap", ['int', -1590475853]);
	}
	getId(){
	...
	getField6997(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"ba", ['int', -644739423]);
	}
	getField6998(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bb", ['int', 2114362069]);
	}
	getShiftClickIndex(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bd", ['int', -2015703661]);
	}
	getField7001(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"be", ['int', -1605896851]);
	}
	getOffsetY2d(){
	...
	getZan2d(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bp", ['int', -1283259697]);
	}
	getGroundActions(){
	...
	getField7015(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bt", ['int', -1895959657]);
	}
	getField7019(){
	...
	getPlaceholderTemplate(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"ca", ['int', -310374151]);
	}
	getUnnotedId(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"cf", ['int', -360275595]);
	}
	getNotedId(){
	...
	getField7017(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bv", ['int', -1243017777]);
	}
	getField7021(){
	...
	getIsStackable(){
		return  super.getField(ItemDefinition.obfuscatedClassName,"bf", ['int', -941752867]);
	}
	getField7018(){
