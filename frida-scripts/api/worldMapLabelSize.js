...
class WorldMapLabelSize extends Interceptor {
	...
	getField2343(){
		return  super.getField(WorldMapLabelSize.obfuscatedClassName,"ah", ['int', -671413539]);
	}
	getField2344(){
		return  super.getField(WorldMapLabelSize.obfuscatedClassName,"as", ['int', 941052287]);
	}
	getField2345(){
		return  super.getField(WorldMapLabelSize.obfuscatedClassName,"ax", ['int', -35502567]);
	}
