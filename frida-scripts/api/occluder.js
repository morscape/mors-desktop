...
class Occluder extends Interceptor {
	...
	getMinZ(){
		return  super.getField(Occluder.obfuscatedClassName,"al", ['int', -1247153957]);
	}
	getField37(){
		return  super.getField(Occluder.obfuscatedClassName,"am", ['int', 1261619785]);
	}
	getField38(){
		return  super.getField(Occluder.obfuscatedClassName,"an", ['int', -146517779]);
	}
	getField39(){
		return  super.getField(Occluder.obfuscatedClassName,"ap", ['int', -1035578667]);
	}
	getField40(){
	...
	getField43(){
		return  super.getField(Occluder.obfuscatedClassName,"aw", ['int', -243764517]);
	}
	getField45(){
		return  super.getField(Occluder.obfuscatedClassName,"ay", ['int', 2125444847]);
	}
	getMinTileY(){
		return  super.getField(Occluder.obfuscatedClassName,"ai", ['int', -1065032201]);
	}
	getMinTileX(){
