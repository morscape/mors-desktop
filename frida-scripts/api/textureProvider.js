...
class TextureProvider extends Interceptor {
	...
	getCapacity(){
		return  super.getField(TextureProvider.obfuscatedClassName,"ai", ['int', -1344360215]);
	}
	getTextures(){
		return  super.getField(TextureProvider.obfuscatedClassName,"ak", []);
	}
	getRemaining(){
		return  super.getField(TextureProvider.obfuscatedClassName,"ax", ['int', -1132635223]);
	}
