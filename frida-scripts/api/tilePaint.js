...
class TilePaint extends Interceptor {
	...
	getSeColor(){
		return  super.getField(TilePaint.obfuscatedClassName,"ae", ['int', -279493619]);
	}
	getTexture(){
		return  super.getField(TilePaint.obfuscatedClassName,"ah", ['int', 418445531]);
	}
	getRgb(){
		return  super.getField(TilePaint.obfuscatedClassName,"aj", ['int', -955256479]);
	}
	getIsFlat(){
	...
	getNwColor(){
		return  super.getField(TilePaint.obfuscatedClassName,"ax", ['int', -562451135]);
	}
