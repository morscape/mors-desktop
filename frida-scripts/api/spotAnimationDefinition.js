...
class SpotAnimationDefinition extends DualNode {
	...
	getField7147(){
		return  super.getField(SpotAnimationDefinition.obfuscatedClassName,"as", ['int', -1381504081]);
	}
	getField7148(){
		return  super.getField(SpotAnimationDefinition.obfuscatedClassName,"aw", ['int', -1297326877]);
	}
	getField7149(){
