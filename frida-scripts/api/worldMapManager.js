...
class WorldMapManager extends Interceptor {
	...
	getField2305(){
		return  super.getField(WorldMapManager.obfuscatedClassName,"an", ['int', -1180595371]);
	}
	getField2306(){
		return  super.getField(WorldMapManager.obfuscatedClassName,"aq", ['int', -822197255]);
	}
	getField2307(){
		return  super.getField(WorldMapManager.obfuscatedClassName,"as", []);
	}
	getField2308(){
		return  super.getField(WorldMapManager.obfuscatedClassName,"aw", ['int', -239663557]);
	}
	getField2310(){
