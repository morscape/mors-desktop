...
class WorldMap extends Interceptor {
	...
	getField4220(){
		return  super.getField(WorldMap.obfuscatedClassName,"ag", ['int', -1082150325]);
	}
	getField4221(){
	...
	getField4239(){
		return  super.getField(WorldMap.obfuscatedClassName,"bg", ['int', -810680801]);
	}
	getField4240(){
		return  super.getField(WorldMap.obfuscatedClassName,"bh", ['int', -1001785649]);
	}
	getField4242(){
	...
	getField4255(){
		return  super.getField(WorldMap.obfuscatedClassName,"by", ['int', -1909728603]);
	}
	getField4259(){
		return  super.getField(WorldMap.obfuscatedClassName,"cf", ['int', -939293837]);
	}
	getField4262(){
	...
	getField4266(){
		return  super.getField(WorldMap.obfuscatedClassName,"cv", ['int', -588111153]);
	}
	getMenuOpcodes(){
		return  super.getField(WorldMap.obfuscatedClassName,"cw", []);
	}
	getCenterTileY(){
		return  super.getField(WorldMap.obfuscatedClassName,"ad", ['int', -1593882191]);
	}
	getCacheLoader(){
		return new WorldMapArchiveLoader(super.getField(WorldMap.obfuscatedClassName,"at", []));
	}
	getCenterTileX(){
		return  super.getField(WorldMap.obfuscatedClassName,"av", ['int', -1112127371]);
	}
	getField4235(){
		return  super.getField(WorldMap.obfuscatedClassName,"bc", ['int', -1943753595]);
	}
	getField4241(){
		return  super.getField(WorldMap.obfuscatedClassName,"bi", ['int', -733842297]);
	}
