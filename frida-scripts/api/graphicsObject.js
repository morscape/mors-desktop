...
class GraphicsObject extends Entity {
	...
	getField7509(){
		return  super.getField(GraphicsObject.obfuscatedClassName,"ae", ['int', -1050607961]);
	}
	getField7510(){
		return  super.getField(GraphicsObject.obfuscatedClassName,"ah", ['int', -643699983]);
	}
	getField7512(){
		return new SequenceDefinition(super.getField(GraphicsObject.obfuscatedClassName,"aj", []));
	}
	getFrame(){
		return  super.getField(GraphicsObject.obfuscatedClassName,"al", ['int', -95037147]);
	}
	getField7515(){
		return  super.getField(GraphicsObject.obfuscatedClassName,"as", ['int', -77648591]);
	}
	getField7511(){
