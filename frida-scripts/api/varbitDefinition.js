...
class VarbitDefinition extends DualNode {
	...
	static getPort1(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"da", ['int', -1785535847]);
	}
	getField6832(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"ac", []);
	}
	getField6834(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"ag", ['int', -168128543]);
	}
	getField6835(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"am", ['int', -1883831779]);
	}
	getField6836(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"an", ['int', 963496239]);
	}
	getField6837(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"ao", ['int', -372731229]);
	}
	getField6838(){
	...
	getField6840(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"ar", ['int', -1179157061]);
	}
	getField6842(){
	...
	getField6846(){
		return  super.getField(VarbitDefinition.obfuscatedClassName,"az", ['int', -1592788279]);
	}
	getField6847(){
