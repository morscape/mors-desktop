...
class class275 extends Interceptor {
	...
	getField5009(){
		return  super.getField(class275.obfuscatedClassName,"ae", ['int', -620568053]);
	}
	getField5010(){
		return  super.getField(class275.obfuscatedClassName,"ah", ['int', -1977650265]);
	}
	getField5013(){
		return  super.getField(class275.obfuscatedClassName,"as", ['int', -146223909]);
	}
	getField5011(){
	...
	getField5014(){
		return  super.getField(class275.obfuscatedClassName,"ax", ['int', -2115459421]);
	}
