...
@Implements(value="CategoryListRecyclerViewAdapter$ViewHolder$3")
class CategoryListRecyclerViewAdapter$ViewHolder$3
implements View.OnClickListener {
    final /* synthetic */ CategoryListRecyclerViewAdapter$ViewHolder this$1;

    CategoryListRecyclerViewAdapter$ViewHolder$3(CategoryListRecyclerViewAdapter$ViewHolder categoryListRecyclerViewAdapter$ViewHolder) {
        this.this$1 = categoryListRecyclerViewAdapter$ViewHolder;
    }

    public void onClick(View view) {
        view = new Intent("android.intent.action.VIEW", Uri.parse((String)"https://www.jagex.com/terms"));
