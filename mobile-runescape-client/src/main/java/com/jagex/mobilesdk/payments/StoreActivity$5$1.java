...
@Implements(value="StoreActivity$5$1")
class StoreActivity$5$1
implements FetchImageComms$FetchImageCallback {
    ...
    StoreActivity$5$1(StoreActivity$5 storeActivity$5, Context context) {
    ...
    public void onFetchImageResult(CommsResult commsResult, Exception exception) {
        if (commsResult.responseCode == 200 && this.val$storeActivityContext != null && commsResult != null) {
            this.this$1.this$0.shopLogo.setBackground((Drawable)new BitmapDrawable(this.val$storeActivityContext.getResources(), (Bitmap)commsResult.getResultValue()));
        }
    }
}
