...
@Implements(value="MobilePayments$6")
class MobilePayments$6
implements BillingClientWrapper$BillingClientWrapperListener {
    ...
    MobilePayments$6(MobilePayments mobilePayments, MobilePayments$MobilePaymentsListener mobilePayments$MobilePaymentsListener) {
