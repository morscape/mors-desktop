...
@Implements(value="CategoryListRecyclerViewAdapter$3")
class CategoryListRecyclerViewAdapter$3
implements FetchImageComms$FetchImageCallback {
    ...
    CategoryListRecyclerViewAdapter$3(CategoryListRecyclerViewAdapter categoryListRecyclerViewAdapter, CategoryListRecyclerViewAdapter$ViewHolder categoryListRecyclerViewAdapter$ViewHolder) {
